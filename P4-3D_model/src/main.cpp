...
int main()
{
    ...
    // load models
    // -----------
    Model planetModel("objects/car.obj");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        model = glm::rotate(model, rotationAngle, rotationAxisVector);
        ...
        planetShader.setVec4("Light.Position", 
            view * glm::vec4( 10.0f * cos(rotationAngle),1.0f,10.0f * sin(rotationAngle),1.0f) );
