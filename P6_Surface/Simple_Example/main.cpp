...
int main()
{
    ...
    const glm::vec3 P1 = glm::vec3(0.0, -0.5, 0.0);
    const glm::vec3 P2 = glm::vec3(0.0, 0.5, 0.0);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        // glBindVertexArray(surfaceVAO);
        //glDrawArrays(GL_TRIANGLE_FAN, 0, 3*(Nu+1)*(Nv+1));
        //glDrawArrays(GL_POINTS, 0, (Nu+1)*(Nv+1));
